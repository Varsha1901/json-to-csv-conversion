...
progressBar = ttk.Progressbar(label_convert, orient="horizontal", length=280,mode="determinate")
progressBar.grid(row=3,column=1, padx=20, pady=30)
